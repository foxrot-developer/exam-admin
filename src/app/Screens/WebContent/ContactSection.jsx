        ...
        <Box component="div" className={classes.root}>
                                        ...
                                        updateContactSection(
                                            {
                                                ...
                                                contact_ar: JSON.stringify(
                                                    about.about_ar
                                                ),
                                                contact_nl: JSON.stringify(
                                                    about.about_nl
                                                ),
                                            },
                                            setOpen
            ...
            {english != null && english.sections !== undefined && (
                <SimpleCard title="English">
                    <PaginationTable
                        data={JSON.parse(english.sections.contact)}
                    />
                </SimpleCard>
            )}
            {arabic != null && arabic.sections !== undefined && (
                <SimpleCard title="Arabic">
                    <PaginationTable
                        data={JSON.parse(arabic.sections.contact)}
                    />
                </SimpleCard>
            )}
            {netherland != null && netherland.sections !== undefined && (
                <SimpleCard title="Netherland">
                    <PaginationTable
                        data={JSON.parse(netherland.sections.contact)}
                    />
                </SimpleCard>
            )}
        </Box>
