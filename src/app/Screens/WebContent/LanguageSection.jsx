    ...
    return (
        <Box component="div" className={classes.root}>
            <Box component="div" mb={4} className={classes.btnRoot}>
                ...
                <Typography variant="h4">Langauge Section</Typography>
            </Box>
                                        ...
                                        updateLanguage(
                                            {
                                                ...
                                                language_ar: JSON.stringify(
                                                    about.about_ar
                                                ),
                                                language_nl: JSON.stringify(
                                                    about.about_nl
                                                ),
                                            },
                                            setOpen
            ...
            {english != null && english.sections !== undefined && (
                <SimpleCard title="English">
                    <PaginationTable
                        data={JSON.parse(english.sections.language)}
                    />
                </SimpleCard>
            )}
            {arabic != null && arabic.sections !== undefined && (
                <SimpleCard title="Arabic">
                    <PaginationTable
                        data={JSON.parse(arabic.sections.language)}
                    />
                </SimpleCard>
            )}
            {netherland != null && netherland.sections !== undefined && (
                <SimpleCard title="Netherland">
                    <PaginationTable
                        data={JSON.parse(netherland.sections.language)}
                    />
                </SimpleCard>
            )}
        </Box>
